...
🔹 **Settings** — UI controls for theme/wallpaper and preferences  
🔹 **Time & Clock** — Live system clock display  
🔹 **Notes** — Simple note taking interface  
🔹 **Stopwatch** — Start/stop timer tool  

---

## 🧪 Usage

Clone the repository and open the project in your favorite editor to explore the OS UI logic, animations, and interactions. Components are modular and designed for future extension.
