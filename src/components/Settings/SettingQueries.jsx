    ...
    return (
        Queries ? <div style={{
            ...
            <div style={{
                ...
                <div style={{
                  borderColor: ThemeColors.third,  backgroundColor: ThemeColors.third, transitionProperty: 'color, background-color, border-color, font-size',
                    transitionDuration: Speed,
                    transitionTimingFunction: CSS_EASING[Animation]
                    ...
                    <div style={{ color: COMMON_COLORS.Blue }} className={`w-fit flex flex-col gap-1 text-sm select-none`}>
                        ...
                        {Queries?.map(({ query }, idx) => {
                            return <span key={idx}
                                style={{
                                  fontSize : Sizes.Small,  fontFamily: Weights.Regular, transitionProperty: 'color, background-color, border-color, font-size',
                                    transitionDuration: Speed,
                                    transitionTimingFunction: CSS_EASING[Animation]
                                }}
