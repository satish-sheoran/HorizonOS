                    ...
                    Wallpapers[Device !== 'Desktop' ? 'mobile' : 'desktop']?.
                        map(({ name: WallpaperName, id, url, description: WallpaperDesc }, index) => {
                            ...
                            return <div
                                ...
                                key={index}
                                style={{
                                    borderColor: currentPreview === url ? ACCENT_COLORS.find(({ COLOR }) => COLOR === 'Purple').CODE : ThemeColors.bg, backgroundImage: `url(${url})`, 
                                }}
                                ...
                                <div style={{
                                    ...
                                    <p style={{
                                       fontSize : `${(Sizes.ExtraSmall.slice(0,-3))*0.85}rem`, fontFamily: Weights.Regular, color: ThemeColors.secText, 
                                    }}
                                        className={`max-w-[90%]`}>
                                        {WallpaperDesc}
                                    </p>
