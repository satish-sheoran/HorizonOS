...
transitionTimingFunction : CSS_EASING[Animation]}} className={`setting-theme-div grid grid-cols-2 md:flex  ${Device !== 'Desktop' ? 'w-full' : !fullScreen ? 'max-w-100' : 'max-w-125'}`}>
...
transitionTimingFunction : CSS_EASING[Animation]}}
                        ...
                        <img
                            ...
                            style={{outlineColor : COMMON_COLORS.Blue,transitionProperty : 'color, background-color, border-color',
transitionDuration : Speed,
transitionTimingFunction : CSS_EASING[Animation]}}
