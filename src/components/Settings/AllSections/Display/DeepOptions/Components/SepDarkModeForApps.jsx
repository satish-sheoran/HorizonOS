  ...
  return (
    <div className={`flex flex-col gap-2 `}>
      <div className='flex flex-col gap-0.5'>
        <span style={{ color: ThemeColors.primaryText }} className={`ease-out duration-500 text-[0.8rem] font-bold ${Device !== 'Desktop' ? 'px-3' : 'px-2.5'}`}>Dark mode for apps</span>
        <span style={{ color: ThemeColors.thirdText }} className={`ease-out duration-500 text-[0.6rem]  ${Device !== 'Desktop' ? 'px-3' : 'px-2.5'}`}>Choose which apps should use dark mode.</span>
      </div>
