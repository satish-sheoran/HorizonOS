...
transitionDuration : Speed,
transitionTimingFunction : CSS_EASING[Animation] }} className={` text-[0.6rem]  ${Device !== 'Desktop' ? 'px-3' : 'px-2.5'}`}>Choose how animations move and feel throughout {OS_NAME}.</span>
            </div>
...
transitionTimingFunction : CSS_EASING[Animation]
                    ...
                    >
                        <div className={`flex items-center gap-3`}>
                            {Icon && <Icon style={{color : DisplayAnimName===Name ? AccentColors.CODE : ThemeColors.primaryText,transitionProperty : 'color, background-color, border-color',
transitionDuration : Speed,
transitionTimingFunction : CSS_EASING[Animation]}} strokeWidth={2} />}
...
transitionDuration : Speed,
transitionTimingFunction : CSS_EASING[Animation] }} className={`font-semibold text-[0.55rem] `}>{description}</span>
                            </div>
                        </div>
                        <div style={{ borderColor:ThemeColors.bg ,backgroundColor : DisplayAnimName===Name ? AccentColors.CODE : '',transitionProperty : 'color, background-color, border-color',
transitionDuration : Speed,
transitionTimingFunction : CSS_EASING[Animation]}} className={`${DisplayAnimName===Name ? '':'border'}  w-6 h-6 rounded-full  flex justify-center items-center`}>
                           {DisplayAnimName===Name && <Icons.Check style={{transitionProperty : 'color, background-color, border-color',
transitionDuration : Speed,
transitionTimingFunction : CSS_EASING[Animation]}} strokeWidth={3} size={Device !== 'Desktop' ? 15 : 20} /> }
                        </div>
                    </button>
                })}
            </div>
