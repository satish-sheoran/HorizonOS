...
const HorizonOS = ({Theme, Device, fullScreen, GrandParentSection, Options, Section, ThemeColors, AccentColors}) => {
  return (
    <div style={{ backgroundColor: ThemeColors.header }} className={`active:scale-97 ease-out duration-500 shrink-0 w-full ${Device !== 'Desktop' ? 'h-55' : 'h-60'} flex flex-col items-center justify-center gap-2 rounded-2xl`}>
