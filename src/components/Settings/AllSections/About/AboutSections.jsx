...
const AboutSections = ({ Theme, Device, fullScreen, ThemeColors, AccentColors, ParentSection, Section: CurrSection }) => {
    ...
    return (
        <section id='About Us' className={`about-us-overflow-area flex flex-col gap-2 ${Device === 'Mobile' ? 'w-full py-[2.5%]' : !fullScreen ? 'w-full' : 'border-r w-full h-full overflow-y-auto  p-[2.5%]'} `}>
