    ...
    return (
        ...
        >
            ...
            <div className={`warning-msg flex flex-col gap-1`}>
                <span style={{
                  fontSize : Sizes.Regular,  fontFamily: Weights.SemiBold, color: COMMON_COLORS.Red, 
                }} className={`font-semibold `}>Factory Reset</span>
                <span style={{
                  fontSize : Sizes.ExtraSmall ,  fontFamily : Weights.Regular ,color: ThemeColors.secText, 
