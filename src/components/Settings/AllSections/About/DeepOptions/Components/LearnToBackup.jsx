    ...
    return (
        <div style={{
            ...
            <div className={`flex flex-col`}>
                <span
                    style={{
                       fontFamily : Weights.SemiBold , color: Theme !== 'dark' ? ThemeColors.primaryText : ThemeColors.secText, transitionProperty: 'color, background-color, border-color',
                        transitionDuration: Speed,
                        transitionTimingFunction: CSS_EASING[Animation]
                    }}
                ...
                <div style={{
                    ...
                    <span
                        ...
                        style={{
                            fontFamily : Weights.Regular ,color: COMMON_COLORS.Blue,
