...
transitionTimingFunction : CSS_EASING[Animation]}}
            className={`flex gap-2 font-bold text-lg `}>
                <Monitor style={{ color : AccentColors.CODE,transitionProperty : 'color, background-color, border-color',
transitionDuration : Speed,
...
transitionDuration : Speed,
transitionTimingFunction : CSS_EASING[Animation]}} className={`font-[450] text-sm flex flex-col gap-4`}>
                <>
