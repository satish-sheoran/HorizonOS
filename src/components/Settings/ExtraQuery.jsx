...
const ExtraQuery = ({ theme, Device, fullScreen, Section }) => {
    return (
        <div className={`flex  pt-3 pb-5 px-[3.5%] ${Device !== 'Desktop' ? 'w-full h-fit' : !fullScreen ? 'w-full h-fit' : 'w-3/10 h-full pt-10 justify-center sticky left-0 top-0'}`}>

            <div className={`${Device !== 'Desktop' ? 'w-full' : 'w-fit'} h-fit flex flex-col gap-4`}>
                ...
                <div className={`flex flex-col gap-2 rounded-xl 
                    ...
                    <div className={`w-fit flex flex-col gap-1 ${Device !== 'Desktop' ? 'text-(--text-currCat)' : 'text-(--sec-light-clr)'} text-sm select-none`}>
