...
const ToggleButton = ({ Device,theme, action, performAction, isActionActive }) => {

    return (
            <div
                onClick={performAction}
                className={`border duration-500 ease-out select-none font-semibold  rounded-2xl flex items-center justify-between 
