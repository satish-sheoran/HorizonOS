...
transitionDuration : Speed,
transitionTimingFunction : CSS_EASING[Animation]}}
            className={`px-4 py-1.5  text-2xl font-bold capitalize md:text-xl  select-none `}>{id === 'notes' ? activeTab : id}</p>
            <div style={{color : COMMON_COLORS.Black,transitionProperty : 'color, background-color, border-color',
transitionDuration : Speed,
transitionTimingFunction : CSS_EASING[Animation]}} className="mobile-controls " >
