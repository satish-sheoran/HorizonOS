    ...
    return (
        <div className={`setting-n-folders `}>
            ...
            {activeTab === 'Notes' ? <button onClick={() => {
                ...
                <FolderClosed style={{transitionProperty : 'color, background-color, border-color',
transitionDuration : Speed,
transitionTimingFunction : CSS_EASING[Animation]}} className={`note-icons   ${isOpen === true ? "opacity-0 pointer-events-none" : 'opacity-100'}`} />
            </button> : ''}
